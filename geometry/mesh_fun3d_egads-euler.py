...
# case = "turbulent"
if case == "inviscid":
    project_name = "aob-inviscid"
else:  # turbulent
    project_name = "aob-turb"
mirror = False
finite_TE = True
# ------------------------------------------------
...
fun3d_model = Fun3dModel.build(
    ...
    problem_name="capsFluidsEgads-Euler",
    volume_mesh="aflr3",
    surface_mesh="egads",
    verbosity=0,
)
...
# mirror and finite_TE are only options when not using Kulfan
# if mirror:
#     fun3d_aim.set_config_parameter("mirror", 1)
# else:
#     fun3d_aim.set_config_parameter("mirror", 0)
# if finite_TE:
#     fun3d_aim.set_config_parameter("cfd:sharpTE", 0)
# else:
#     fun3d_aim.set_config_parameter("cfd:sharpTE", 1)
